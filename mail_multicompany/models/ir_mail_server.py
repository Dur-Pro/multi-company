...
class IrMailServer(models.Model):
    ...
    #     if (not reply_to or catchall in reply_to) and current_company.email_reply_to:
    #         reply_to = current_company.email_reply_to
    #
    #     return super(IrMailServer, self).build_email(email_from, email_to, subject, body, email_cc, email_bcc,
